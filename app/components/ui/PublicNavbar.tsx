...
const simpleMenus: { about: SimpleMenuItem[]; merchants: SimpleMenuItem[]; contact: SimpleMenuItem[] } = {
  about: [
    { title: 'ye', subtitle: 'How QORAPP was founded', href: '/public-pages/about#our-story', icon: Building2 },
  ...
  merchants: [
    ...
    { title: 'Restaurants & Bars', subtitle: 'Bills, shifts & cost tracking', href: '/public-pages/industries#food-vendors-and-restaurants', icon: Utensils },
    { title: 'Services & Salons', subtitle: 'Bookings & recurring payments', href: '/public-pages/industries#salons-and-barbershops', icon: Scissors },
